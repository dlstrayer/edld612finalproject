...
> In the final version of visual #1, I have changed the line colors again to a colorblind friendly palette. I've also increased the size to make them easier to see. 
...
### Final Visual 3
```{r vis 34, eval=TRUE, fig.width=4, fig.height=4}
...
### How to interpret pupil variable
